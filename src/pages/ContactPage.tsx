    ...
    <div className="container py-8">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          {[
            { icon: MapPin, title: "Address", text: "Global Imports HQ, 5th Floor, Tech Tower, Cyber City, Gurugram, Haryana 122002" },
            { icon: Phone, title: "Phone", text: "+91 1800-123-4567 (Toll Free)\n+91 98765-43210" },
            { icon: Mail, title: "Email", text: "support@globalimports.com\nsales@globalimports.com" },
