      ...
      <div className="grid md:grid-cols-2 gap-6 md:gap-10">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15, duration: 0.4 }}>
          ...
          <div className="grid grid-cols-2 gap-2 mb-4">
            <div className="flex items-start gap-2 bg-card border border-border rounded-lg p-2.5">
              <BadgeCheck className="w-4 h-4 text-primary shrink-0 mt-0.5" />
              <div>
                <p className="text-[11px] font-semibold">Bank Offer</p>
                <p className="text-[10px] text-muted-foreground">10% off on HDFC Cards</p>
              </div>
            </div>
            <div className="flex items-start gap-2 bg-card border border-border rounded-lg p-2.5">
              <BadgeCheck className="w-4 h-4 text-primary shrink-0 mt-0.5" />
              <div>
                <p className="text-[11px] font-semibold">No Cost EMI</p>
                <p className="text-[10px] text-muted-foreground">Starting ₹{Math.round(effectivePrice / 3).toLocaleString()}/mo</p>
              </div>
            </div>
            <div className="flex items-start gap-2 bg-card border border-border rounded-lg p-2.5">
              <BadgeCheck className="w-4 h-4 text-primary shrink-0 mt-0.5" />
              <div>
                <p className="text-[11px] font-semibold">Exchange Offer</p>
                <p className="text-[10px] text-muted-foreground">Up to ₹5,000 off</p>
              </div>
            </div>
            <div className="flex items-start gap-2 bg-card border border-border rounded-lg p-2.5">
              <BadgeCheck className="w-4 h-4 text-primary shrink-0 mt-0.5" />
              <div>
                <p className="text-[11px] font-semibold">Combo Offer</p>
                <p className="text-[10px] text-muted-foreground">Buy 2 get 5% extra off</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 mb-4">
            ...
            <button
              ...
              disabled={product.stock === 0}
              className="w-full flex items-center justify-center gap-2 bg-accent text-accent-foreground py-3.5 rounded-xl font-semibold hover:opacity-90 transition-all disabled:opacity-50 active:scale-[0.98] shadow-md shadow-accent/20"
            >
