        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-background/60 mb-4">
              Your one-stop destination for computers, phones, and electronic accessories at the best prices.
            </p>
    ...
    <footer className="bg-foreground text-background pb-20 md:pb-0">
      <div className="container py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          {/* Offices */}
          <div>
            <h4 className="font-heading font-semibold mb-4 text-sm">Our Offices</h4>

            <div className="text-sm text-background/60 space-y-4">

              <div>
                <p className="font-semibold text-background/80">China Office</p>
                <p className="text-xs leading-relaxed">
                  Room 1228, No.1 Building,<br/>
                  No.36 Tongda Road, Lanshan District,<br/>
              ...
              <div>
                <p className="font-semibold text-background/80">India Office</p>
                <p className="text-xs leading-relaxed">
                  2nd Floor, Paryag Paradise,<br/>
                  Friends Colony,<br/>
          ...
          <div>
            ...
            <div className="text-sm text-background/60 space-y-4">
              ...
              <div>
                <p className="font-semibold text-background/80">China Office</p>
                <p className="text-xs leading-relaxed">
                  Room 1228, No.1 Buding,<br/>
                  No.36 Of Tongda Road, Lanshan District,<br/>
                  Linyi City, Shandong Province,<br/>
                  China
                </p>
              </div>
